...
if ($style == '') {
	if ($module->position == 'top-a') $style = 'dark';
	if ($module->position == 'top-b') $style = 'dark';
	if ($module->position == 'bottom-a') $style = 'dark';
	if ($module->position == 'bottom-b') $style = 'dark';
	if ($module->position == 'innertop') $style = 'dark';
	if ($module->position == 'innerbottom') $style = 'dark';
	if ($module->position == 'sidebar-a') $style = 'dark';
	if ($module->position == 'sidebar-b') $style = 'dark';
}
